                ...
                with col1:
                    ...
                    if st.button('Export forecast (.csv)'):
                        with st.spinner("Exporting.."):
                            ...
                            href = f'<a href="data:text/csv;base64,{b64}">Download CSV File</a> (right click > save as **forecast.csv**)'
                ...
                with col2:
                    ...
                    if st.button("Export model metrics (.csv)"):
                        try:
                            ...
                            href = f'<a href="data:text/csv;base64,{b64}">Download CSV File</a> (right click > save as **metrics.csv**)'
                            st.markdown(href, unsafe_allow_html=True)
                        except:
